...
public:
	...
	instructions[0][1] = new Container(1,port1,"ABCJ1111111");
	instructions[1][0] = new Container(2,port0,"ABCJ1111112");
	instructions[1][1] = new Container(3,port0,"ABCJ1111113");
	instructions[2][0] = new Container(4,port1,"test");

	// init ship
	Ship ship;
	ship = new Ship(10,10,10,instructions);

	// running stowage
	string** result;
	result = Stowage(0,ship,route,weightBalance);
	}
};
